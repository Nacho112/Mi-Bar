<?php
  ...
  if(empty($_COOKIE['cookiebusqueda'])||$_COOKIE['cookiebusqueda']<=0){
    ...
    if($_GET['pagina']){
      if($_GET['pagina']<=0){
        header("Location: http://localhost/MiBar/Menu-Tarde/MenuTarde.php?pagina=1"); 

      }else{
        $q = "SELECT * FROM menumañana WHERE turno='Tarde' LIMIT $iniciar,8";
      }
    }
...
<html lang="en">
  ...
  <body>
    <div class="titulo"><h1>MENU DE TARDE</h1><br>(Bebidas, Hamburguesas, Postre)</div>
    <div class="img">
              ...
              echo '
                <div class="single-menu">
                  ...
                  <div class="menu-content">
                    <h5>'.$menumañana['nombre'].'<br><br> <span>$'.$menumañana['precio'].'</span></h5>
                  </div>
                </div>
              ';    
            }
        ...
        <nav aria-label="Page navigation example"> <!--PAGINACION-->
          <ul class="pagination">
              ...
              <li class="page-item <?php echo $_GET['pagina']<=1? 'disabled' : '' ?>">
                  <a class="page-link" href="MenuTarde.php?pagina=<?php echo $_GET['pagina']-1 ?>">
                      Previous
                  </a>
              </li>
              ...
              <li class="page-item <?php echo $_GET['pagina']==$i+1 ? 'active' : '' ?>">
                  <a class="page-link" href="MenuTarde.php?pagina=<?php echo $i+1 ?>">
                      <?php echo $i+1 ?>
                  </a>
              </li>
              <?php endfor ?>
